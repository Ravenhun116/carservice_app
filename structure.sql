...
CREATE TABLE `cars` (
  ...
  `ownbrand` tinyint(1) NOT NULL DEFAULT '0',
  `accident` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `services` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `services_car_id_log_number_unique` (`car_id`,`log_number`),
  KEY `services_client_id_foreign` (`client_id`),
  CONSTRAINT `services_car_id_foreign` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`) ON DELETE CASCADE,
...
-- Dump completed on 2026-04-02 10:21:09
